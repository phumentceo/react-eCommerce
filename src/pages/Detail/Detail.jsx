...
export default function Detail() {
  ...
  const [customerReviews, setCustomerReviews] = useState([
    ...
    { id: 2, name: 'Jane Smith', rating: 5, comment: 'Excellent quality!' },
  ]);
  ...
  const handleReviewSubmit = (e) => {
      ...
      if (newComment && newRating > 0) {
        setCustomerReviews([...customerReviews, { id: Date.now(), name: 'Anonymous', rating: newRating, comment: newComment }]);
        setNewRating(0);
        setNewComment('');
      }
  };
    ...
    <div className="bg-white my-[30px]">
      {/* Product detail start */}
        <div className="pt-6">
          ...
          {/* Main Grid Layout */}
          <div className="mx-auto mt-6 lg:grid lg:grid-cols-2">
            ...
            {/* Product Details */}
            <div className="px-4 pb-16 pt-10 sm:px-6 lg:px-8 lg:pb-24 lg:pt-16">
      ...
      {/*ratting and descript start*/}
      <div className="my-[30px] border">
        <div className="border-b border-gray-200">
          <nav className="flex space-x-4" aria-label="Tabs">
            <button
              onClick={() => setActiveTab('description')}
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'description' ? 'border-b-2 border-indigo-500 text-indigo-600' : 'text-gray-500 hover:text-indigo-600'}`}
            >
              Description
            </button>
            <button
              onClick={() => setActiveTab('rating')}
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'rating' ? 'border-b-2 border-indigo-500 text-indigo-600' : 'text-gray-500 hover:text-indigo-600'}`}
            >
              Customer Rating
            </button>
          </nav>
        ...
        <div className="mt-4 p-10">
          {activeTab === 'description' && (
            <div>
              ...
              <p className="mt-2 text-gray-600">This product is made with high-quality materials to ensure durability and comfort.</p>
            </div>
          )}
                  ...
                  <div className="flex items-center mt-1">
                    {[...Array(5)].map((_, index) => (
                      <StarIcon
                        ...
                        className={`w-6 h-6 cursor-pointer ${index < newRating ? 'text-yellow-400' : 'text-gray-300'}`}
                      />
                    ))}
                  </div>
                </div>
